...
<script src="js-code/cola.v3.min.js"></script>
<script src="js-code/jquery.min.js"></script>

<meta charset=utf-8 />
<title>DARET visualization</title>
<!-- main library for network visualization.  -->
  <script src="js-code/cytoscape.min.js"></script>
<style id="jsbin-css">
body { 
...
<img src="images/labels1.jpg"  width="200" height="77" border="0"><br>
			<!-- Multiple checkboxes to get subset of network   -->
	    	&nbsp&nbsp&nbsp<input type="checkbox" id="stitch" value="Yes" checked>STITCH
	    	<input type="checkbox" id="drugbank" value="Yes" checked>Drugbank
	    	<input type="checkbox" id="ttd" value="Yes" checked>TTD<br><br>
	    	<img src="images/labels2.jpg"  width="200" height="50" border="0"><br>
	    	&nbsp&nbsp&nbsp<input type="checkbox" id="atc" value="Yes" checked>ATC
	    	<input type="checkbox" id="ftc" value="Yes" checked>FTC<br><br>
	    	<img src="images/labels3.jpg"  width="200" height="50" border="0"><br>
	    	&nbsp&nbsp&nbsp<input type="checkbox" id="sideeffect" value="Yes" checked>Side effect
